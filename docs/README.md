...
- `runbooks/` — operational runbooks (added later)
- `onboarding/` — new developer setup guide (added later)

Subfolders are populated incrementally as their corresponding planning documents are finalized, rather than pre-created empty.
